...
authors:
  ...
  - "T. Anderson"
  - "J. Gwinnup"
tldr: "Journal extension evaluating per-class binomial reject thresholds across 4 vision, 3 text and 8 synthetic datasets, from 2 to 1,000 classes."
highlight: true
...
citation:
  type: "article"
  key: "kashanimotlagh2025naturally"
